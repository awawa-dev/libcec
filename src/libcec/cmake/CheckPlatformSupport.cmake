...
SET(HAVE_LINUX_API       ON CACHE  BOOL "linux is supported")
SET(HAVE_AOCEC_API       OFF CACHE BOOL "aocec not supported")
# Pulse-Eight devices are always supported
set(HAVE_P8_USB          OFF CACHE BOOL "p8 usb-cec supported" FORCE)
...
IF (EXISTS "/opt/vc/lib" AND EXISTS "/opt/vc/include")
	set(RPI_LIB_DIR     "/opt/vc/lib" CACHE STRING "Path to Raspberry Pi libraries (x32)")
	set(RPI_INCLUDE_DIR "/opt/vc/include" CACHE STRING "Path to Raspberry Pi headers (x32)")
	SET(HAVE_RPI_API    ON CACHE  BOOL "raspberry pi 32-bits is supported")
elseif (EXISTS "/usr/lib/aarch64-linux-gnu" AND EXISTS "/usr/include" AND EXISTS "/usr/lib/aarch64-linux-gnu/libbcm_host.so.0")
	...
	SET(HAVE_RPI_API    ON CACHE  BOOL "raspberry pi aarch64 is supported")
else()
	set(RPI_LIB_DIR     "" CACHE STRING "Path to Raspberry Pi libraries")
	set(RPI_INCLUDE_DIR "" CACHE STRING "Path to Raspberry Pi headers")
	SET(HAVE_RPI_API    OFF CACHE  BOOL "raspberry pi is not supported (dev libs not found)")
endif()
